defmodule Functions do
  ...
  koan "You can build anonymous functions out of any elixir expression by prefixing it with & map" do
      stuff = &%{first: &1, second: &2, third: &3}
      assert stuff.(:first, :second, :third) == %{first: :first, second: :second, third: :third}
  end
  ...
  koan "Conveniently keyword lists can be used for function options" do
    ...
    assert transform.("good", upcase: true, sex: :yes_please) == "GOOD"
